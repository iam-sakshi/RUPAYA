...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
        <div class="small card-text mb-3">
            Choose an option below to perform a transaction
        </div>
      <select name="transact-type" class="form-control my-3" id="transact-type" onchange="myFunction()">
        <option value="vl">---select Transaction Type---</option>
