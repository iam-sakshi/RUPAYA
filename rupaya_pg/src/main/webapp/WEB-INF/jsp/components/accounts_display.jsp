...
<div class="container d-flex">
    <div class="container">
        <button id="add-account-btn" class="btn shadow" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
      ...
      <button id="transact-btn" class="btn ms-auto shadow" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
        <i class="fa fa-wallet"></i> Transact</button>    
</div>
              ...
              <div id="flush-${account.account_id}" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex">Last updated at <span class="ms-auto"><b>${account.updated_at}</b></span></li>
                    </ul>
                </div>
              </div>
            </div>
